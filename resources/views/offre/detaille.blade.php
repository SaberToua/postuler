<x-app-layout>
                ...
                <div class="flex-1">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="flex gap-3">
                            @foreach ($tools as $tool)
                                @if($tool && $tool->path)
                                    <img class="w-10 h-10 rounded-lg border border-gray-200 dark:border-gray-600" 
                                         src="{{ asset('storage/' . $tool->path) }}" 
                                         alt="{{ $tool->name }}" 
                                         title="{{ $tool->name }}">
                                @else
                                    <div class="w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 flex items-center justify-center">
                        ...
                        @auth
                            <button x-data="" 
                                    x-on:click.prevent="$dispatch('open-modal', 'postuler')" 
                        ...
                        @else
                            <button x-data="{ isLoggedIn: {{ Auth::check() ? 'true' : 'false' }} }" 
                                    x-on:click.prevent="$dispatch('open-modal', 'login')" 
                                    class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5 15.747V18a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.253m-6.798-9.83v8.5m3.344-6.15L12.202 5L8.858 8.267"/>
                                </svg>
                    ...
                    <div class="text-center mb-8">
                        <div class="flex justify-center mb-4">
                            <img class="w-80 h-48 object-cover rounded-xl shadow-md" 
                        ...
                        <div class="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-4">
                            ...
                            <span>{{ $offre->created_at->format('j M Y, g:i a') }}</span>
                        ...
                        <p class="text-xl font-semibold text-indigo-600 dark:text-indigo-400 mb-4">
                            {{ $offre->company }}
                        </p>
                        ...
                        <div class="flex items-center justify-center gap-2 text-gray-600 dark:text-gray-400">
                            ...
                            <span class="text-lg">{{ $offre->lieu }}</span>
                        </div>
                    </div>

                    <!-- Contact & Website Buttons -->
                    <div class="flex justify-center gap-4 mb-8">
                        @php $employer = App\Models\User::find($offre->workowner); @endphp
                        <a href="mailto:{{ $employer->email ?? '#' }}"
                           class="inline-flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                        ...
                        <a href="{{ $offre->site }}" target="_blank"
                           class="inline-flex items-center gap-2 px-6 py-3 bg-gray-800 hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 text-white rounded-lg transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-6">
                            <div class="flex items-center gap-3 mb-4">
                                <svg class="h-8 w-8 text-indigo-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
                                    <path fill="currentColor" d="M20 14h-4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1m-.4 6.6h-3.2v-5.2h3.2Z" className="clr-i-outline clr-i-outline-path-1"/>
                                    <path fill="currentColor" d="m33.71 12.38l-4.09-4.09a1 1 0 0 0-.7-.29h-5V6.05A2 2 0 0 0 22 4h-8.16A1.92 1.92 0 0 0 12 6.05V8H7.08a1 1 0 0 0-.71.29l-4.08 4.09a1 1 0 0 0-.29.71V28a2 2 0 0 0 2 2h28a2 2 0 0 0 2-2V13.08a1 1 0 0 0-.29-.7M14 6h8v2h-8Zm18 11H22v1.93h10V28H4v-9.07h10V17H4v-3.5L7.5 10h21l3.5 3.5Z" className="clr-i-outline clr-i-outline-path-2"/>
                                    <path fill="none" d="M0 0h36v36H0z"/>
                                </svg>
                                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Recommended Tools</h2>
                            </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                                <div class="flex items-center gap-3 mb-4">
                                    <svg class="h-7 w-7 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    ...
                                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Important</h3>
                                </div>
                                <div class="text-gray-700 dark:text-gray-300 prose dark:prose-invert max-w-none">
                                    {!! nl2br(e($offre->points)) !!}
                                </div>
                            </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                                <div class="flex items-center gap-3 mb-4">
                                    <svg class="h-7 w-7 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                    ...
                                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Required Skills</h3>
                                </div>
                                <div class="text-gray-700 dark:text-gray-300 prose dark:prose-invert max-w-none">
                                    {!! nl2br(e($offre->skills)) !!}
                                </div>
                            </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                                <div class="flex items-center gap-3 mb-4">
                                    <svg class="h-7 w-7 text-blue-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
                                    ...
                                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Responsibilities</h3>
                                </div>
                                <div class="text-gray-700 dark:text-gray-300 prose dark:prose-invert max-w-none">
                                    {!! nl2br(e($offre->works)) !!}
                                </div>
    ...
    @auth
        <x-modal name="postuler" :show="$errors->get('user_id')||$errors->get('Cemail')||$errors->get('Cname')">
            <!-- Your existing modal content for CV submission -->
            @include('offre.workerinput')
        </x-modal>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCO_JbB75acgxNQNe7RikwXKqpQMLFd5co"></script>
    <script>
        function initMap() {
            const savedLocation = {
                lat: {{ $offre->latitude }},
